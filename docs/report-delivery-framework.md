...
## Purpose
Define scheduling, generation, packaging, and delivery of reports.

**Relationship to report-registry.md:** This specification defines the feature-layer behavior. Canonical entities, relationships, and lifecycle originate in `report-registry.md`.
...
## Data Model
Uses canonical entities from `report-registry.md` and does not redefine them.
